...
import photo from "../images/WelcomeIdea.png";
...
{/*         <div className="img-1">
        ...
        <p className="vision" style={{ color: "white" }}>
          Used by the visionaries, on payroll from
        </p>
